...
{"urlButton": {"displayText": "𝚈𝚘𝚞𝚃𝚞𝚋𝚎","url": "https://www.youtube.com/channel/UCQTkxpDWN8pinsquCr_ZLrA"}},
{"urlButton": {"displayText": "𝙾𝚠𝚗𝚎𝚛","url": "https://wa.me/" + nomerowner}},
{"quickReplyButton": {"displayText": "𝙶𝚛𝚘𝚞𝚙 𝙱𝚘𝚝","id": `${prefix}donasi`}},
{"quickReplyButton": {"displayText": "𝙼𝚢 𝙿𝚛𝚘𝚏𝚒𝚕𝚎","id": `${prefix}saya`,}},
{"quickReplyButton": {"displayText": "𝙱𝚘𝚝 𝚅𝚎𝚛𝚜𝚒𝚘𝚗","id": `${prefix}versi`}}
]}}}, {})
...
const nyz4 = {text:dua,footer: '©𝚊𝚛𝚢𝚊',buttons: nyz3,headerType: 1}
...
const nyz6 = {image: {url: tiga},caption: dua,footer: '©𝚊𝚛𝚢𝚊',buttons: nyz5,headerType: 4}
nayla.sendMessage(from, nyz6)}

const reply = (teksnya) => {
const nyz1 = [{index: 1, urlButton: {displayText: '𝚌𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚊𝚛𝚢𝚊', url: 'https://wa.me/' + nomerowner}}]
...
await sendMenu(from, menuu, "𝙴𝚇𝙴 𝙱𝙾𝚃 - ᴄʀᴇᴀᴛᴇᴅ ʙʏ 𝚊𝚛𝚢𝚊", await nayla.sendnew(from, {image : {url:`./media/image/menu/${gg}.jpg` }, caption: menuu}),{quoted:nay1})
break
case 's':
case 'sticker':
case 'stiker':
...
reply("_Maaf server sedang error, coba lagi dengan reply gambar/video dengan caption !sticker, *jika tetap terjadi error lapor ke owner bot*_")
}
break 
case 'editinfo':
case 'editinfogroup':
